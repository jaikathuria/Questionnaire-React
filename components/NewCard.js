    ...
    render () {
        return (
            <KeyboardAvoidingView behavior="padding" style={[styles.container]}>
                <View style={[styles.card,styles.shadow, styles.center, {flex: 0.35}, {paddingLeft: 25, paddingRight: 25}]} >
                    <TextField
                        label="Question"
                ...
                <View style={[styles.card, styles.shadow , styles.center, {flex: 0.25, justifyContent:'flex-end'}]} >
                    ...
                    <View style={[{flex: 1,flexDirection: 'row', justifyContent:'center', alignItems: 'center'},{position: 'absolute', top: 0, bottom: 0, left: 0, right: 0},{backgroundColor: 'transparent'}]}>
                        ...
                        <Text style={{fontSize: 25,fontWeight: "100"}}>  {this.state.answer === null ? 'UNDEFINED' : this.state.answer ? 'TRUE' : 'FALSE'} </Text>
                    </View>

                </View>
                <View style={[ styles.center, {flex: 0.3, marginTop: 20},{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around'}]}>
                    <TouchableOpacity style={[styles.bool,styles.center, styles.shadow, {shadowOffset: {width: 0,height: 1}}]} activeOpacity={0.7}
                ...
                <TouchableOpacity style={[{flex: 1},styles.center,{backgroundColor:'#f1c40f'},styles.btn]} activeOpacity={0.8} onPress={this.handleSubmit}>
